...
public class GoogleDirectionsURLEncoderTest {
    ...
    public void testEncodeUrl() {
        ...
        String urlWithOutWaypoints = googleDirectionsURLEncoder.encodeURL("41.43206,-81.38992", "41.412,-81.245", new ArrayList<String>());
        ...
        String urlWithWaypoints = googleDirectionsURLEncoder.encodeURL("-33.8688,151.2093", "-31.9505,115.8605", wayPoints);
