...
public class PassengerCardView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(R.style.Theme_MyAwesomeApp_Base);
        setContentView(R.layout.sm_cardview);
        ...
        myAdapter = new MyAdapter(this, PassengerCollection.getPassengers());
